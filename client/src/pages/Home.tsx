          ...
          <div className="p-8 md:p-10 flex flex-col justify-center">
            ...
            <div className="grid grid-cols-2 gap-4 mb-6">
              ...
              <div className="flex items-start space-x-2">
                ...
                <div>
                  <p className="font-medium text-slate-900 dark:text-white">Bootstrapping Guide</p>
                  <p className="text-sm text-slate-700 dark:text-slate-300">DIY solutions for solo developers</p>
                </div>
              </div>
            </div>
